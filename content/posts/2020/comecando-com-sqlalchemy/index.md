...
summary: "Acessando bancos relacionais e criando modelos ORM de forma fácil no Python com o SQL Alchemy."
...
resources:
- name: thumbnail
  src: sql-alchemy-logo.png
  title: sql alchemy logo
---

{{<figure src="thumbnail" alt="sqlalchemy">}}
